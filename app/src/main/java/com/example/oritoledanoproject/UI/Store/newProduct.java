...
public class newProduct extends AppCompatActivity implements View.OnClickListener {
    ...
    // השקת פעילות לתוצאות עבור המצלמה
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        // קבלת התמונה מהמצלמה והצגת אותה ב-ImageView
                        photo = (Bitmap) result.getData().getExtras().get("data");
                        btnImg.setTag("Pic");
                        btnImg.setImageBitmap(photo);
                    } else {
                        Toast.makeText(newProduct.this, "בוטל", Toast.LENGTH_SHORT).show();
                    }
                }
            });

    // השקת פעילות לתוצאות עבור הגלריה
    ActivityResultLauncher<Intent> GalleryActivityResultLauncher = registerForActivityResult(
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        // קבלת התמונה מהגלריה והצגת אותה ב-ImageView
    ...
    // השקת פעילות לתוצאות עבור גרסאות ישנות יותר של הגלריה
    ActivityResultLauncher<PickVisualMediaRequest> OlderGalleryResultActivity =
            registerForActivityResult(new ActivityResultContracts.PickVisualMedia(), uri -> {
                if (uri != null) {
                    // קבלת התמונה והצגת אותה ב-ImageView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> fitsAdapter = new ArrayAdapter<>(newProduct.this,
        ...
        ArrayAdapter<String> situationAdapter = new ArrayAdapter<>(newProduct.this,
        ...
        ArrayAdapter<String> categoryAdapter = new ArrayAdapter<>(newProduct.this,
    ...
    public void onClick(View view) {
        ...
        if (view == btnSend) {
            // בדיקת תקינות הנתונים והוספת מוצר
        ...
        if (view == btnBack) {
            // חזרה לפעילות החנות (StoreActivity)
